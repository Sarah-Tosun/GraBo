...
public class Navigator extends JWindow {
	...
	/**
	 * Wenn das Hauptfenster verschoben wird, muss die Position des Navigators neu gesetzt werden
	 */
	public void updatePosition()
	{
		Hauptfenster hf = (Hauptfenster)this.getParent();
		this.setLocation(hf.getX() + hf.getWidth() + 5, hf.getY());
	}
}
